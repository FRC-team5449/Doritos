...
public class Constants {
    ...
    public static final double maxVelocityMeterPerSec = 7;
    ...
    public static final double maxAngularVelocityRadPerSec = 6; //maxVelocityMeterPerSec / Math.hypot(wheelBaseMeters / 2, trackBaseMeters / 2);
